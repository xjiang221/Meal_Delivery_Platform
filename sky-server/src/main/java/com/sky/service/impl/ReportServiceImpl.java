...
public class ReportServiceImpl implements ReportService {
    ...
    public UserReportVO getUserStatistics(LocalDate begin, LocalDate end) {
        ...
        // 总用户：select count(id) from user where create_time < ?
    ...
    public OrderReportVO getOrderStatistics(LocalDate begin, LocalDate end) {
        ...
        for (LocalDate date : dateList) {
            ...
            // 查询每天的订单总数
            Integer dailyOrder = getOrderCount(beginTime, endTime, null);
        ...
        Integer totalOrderCount = dailyOrderList.stream().reduce(Integer::sum).get();
    ...
    public SalesTop10ReportVO getSalesTop10(LocalDate begin, LocalDate end) {
        // select od.name, sum(od.number) count from order_detail od join orders o on od.order_id = o.id
